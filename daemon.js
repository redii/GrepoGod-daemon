...
const yargs             = require('yargs')                    // for cli args
...
if (yargs.argv._[0] == 'dev') {                                                                               // for development with 'dev' parameter
  god.run('de88')                                                                                             // run with de88
  god.run('de89')                                                                                             // and de89
} else {                                                                                                      // else run the daemon...
  every('120s').do(() => {                                                                                    // every 2 minutes check for world updates
